...
gc = gspread.service_account(filename='creds/creds.json')
sh = gc.open_by_key("find this in the URL where Google Sheet is opened") # or by sheet name: gc.open("TestList")
worksheet = sh.sheet1
'''
### retrieve data ###
